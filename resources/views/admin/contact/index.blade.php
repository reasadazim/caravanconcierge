<x-layouts.app>
    ...
    <div class="mb-3 flex items-center text-sm">
        ...
        <span class="text-gray-500 dark:text-gray-400">{{ __('Contact Tracking') }}</span>
    </div>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Contact Tracking') }}</h1>
        </div>
        <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('Track your contacts here.') }}</p>
    </div>
...
{{--                            @include('admin.contact.partials.import')--}}

                            {{-- END - Import Excel --}}

                            {{-- Export Excel --}}

                            <a href="{{ route("contact.export") }}" class="btn btn-dark">
                                <div class="flex items-center gap-2">
...
{{--                            </button>--}}
                        ...
                        @include('admin.contact.partials.add-new-lead')
...
{{--                        </div>--}}
                    ...
                    @include('admin.contact.partials.edit-lead')
